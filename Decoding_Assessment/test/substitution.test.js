...
describe("substitution() submission tests written by student", () => {
  describe("returns false if alphabet is not exactly 26 characters", () => {
  ...
  describe("correctly translates the phrase", () => {
    it("correctly translates the phrase, based on the given alphabet when encoding", () => {
      const actual = substitution("thinkful", "xoyqmcgrukswaflnthdjpzibev");
      expect(actual).to.equal("jrufscpw");
    });
    it("correctly translates the phrase, based on the given alphabet when decoding", () => {
